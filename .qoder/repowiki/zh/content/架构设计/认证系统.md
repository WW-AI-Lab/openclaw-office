...
subgraph "应用集成"
App[App.tsx<br/>应用入口]
Adapter[adapter-provider.ts<br/>适配器提供者]
...
- [ws-client.ts:1-324](file://src/gateway/ws-client.ts#L1-L324)
...
**图表来源**
- [device-identity.ts:9-105](file://src/gateway/device-identity.ts#L9-L105)
...
- [auth-store.ts:82-106](file://src/store/auth-store.ts#L82-L106)
